 ...
 */
public class CoalsCompounds implements SemanticSpace {
     ...
     */
    public static final String COALS_SSPACE_NAME = "NEW_COALSC";
    ...
    private static final Logger COALS_LOGGER =
        Logger.getLogger(CoalsCompounds.class.getName());
    ...
    /**
     * The maximum number of words that will be retained by {@link cz.zcu.luk.sspace.coals.CoalsCompounds}.
     */
    private final int maxWords;

    /**
     * The maximum number of co-occurring words that will be retained by {@link
     * cz.zcu.luk.sspace.coals.CoalsCompounds}.
     */
    ...
    public CoalsCompounds(TransformExtended transform, MatrixFactorization reducer) {
        this(transform, reducer, DEFAULT_REDUCE_DIMENSIONS,
             DEFAULT_MAX_WORDS, DEFAULT_MAX_DIMENSIONS);
    }

    /**
     * Creats a {@link cz.zcu.luk.sspace.coals.CoalsCompounds} instance.
     */
    public CoalsCompounds(TransformExtended transform,
