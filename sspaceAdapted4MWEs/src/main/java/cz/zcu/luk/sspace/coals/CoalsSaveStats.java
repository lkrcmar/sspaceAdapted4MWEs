 ...
 */
public class CoalsSaveStats implements SemanticSpaceSaveStats {
    ...
    private static final Logger COALS_LOGGER =
        Logger.getLogger(CoalsSaveStats.class.getName());
    ...
    /**
     * The maximum number of words that will be retained by {@link cz.zcu.luk.sspace.coals.CoalsSaveStats}.
     */
    private final int maxWords;

    /**
     * The maximum number of co-occurring words that will be retained by {@link
     * cz.zcu.luk.sspace.coals.CoalsSaveStats}.
     */
    ...
    public CoalsSaveStats(TransformExtended transform, MatrixFactorization reducer) {
        this(transform, reducer, DEFAULT_REDUCE_DIMENSIONS,
             DEFAULT_MAX_WORDS, DEFAULT_MAX_DIMENSIONS);
    }

    /**
     * Creats a {@link cz.zcu.luk.sspace.coals.CoalsSaveStats} instance.
     */
    public CoalsSaveStats(TransformExtended transform,
...
//                System.out.print(finalCorrelation.get(i, j) + " ");
//            }
//            System.out.println();
//        }
//        System.out.println();
...
//        System.out.println();
    ...
    public void saveStatistics(String dirPlusSpaceNameNoExtension) {
        ...
        Serializer.serializeData(termToIndex, dirPlusSpaceNameNoExtension + ".indmap");
        //CorrelationTransformExtendedSerialiazable tr = (CorrelationTransformExtendedSerialiazable)Serializer.deserialiazeData("C:\\IdeaWorkspace\\SSpaceExt\\data\\stats.trans");
        //System.out.println(tr.transformRow(new DenseVector(new double[]{0, 4, 1})));
        //System.out.println(tr.transformRow(new DenseVector(new double[]{4, 2, 3,1,4})));
        //Map<String, Integer> abc = (Map<String, Integer>)Serializer.deserialiazeData("C:\\IdeaWorkspace\\SSpaceExt\\data\\stats.indmap");
