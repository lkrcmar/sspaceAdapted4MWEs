 ...
 */
public abstract class GenericTermDocumentVectorSpaceCompounds
    ...
    protected static final Logger LOG =
        Logger.getLogger(GenericTermDocumentVectorSpaceCompounds.class.getName());
     ...
     */
    public GenericTermDocumentVectorSpaceCompounds() throws IOException {
     ...
     *         the backing array files required for processing
     */
    public GenericTermDocumentVectorSpaceCompounds(
    ...
    public void processDocument(BufferedReader document) throws IOException {
        ...
        while (documentTokens.hasNext()) {
            ...
            String possibleCompoundTrigram = removedOld + " " + removed + " " + word;
            ...
            String possibleCompoundBigram = removed + " " + word;
...
//    }
    ...
    /**
     * Processes the {@link cz.zcu.luk.sspace.common.GenericTermDocumentVectorSpaceCompounds} with the provided
