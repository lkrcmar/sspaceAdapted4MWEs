 ...
 */
public class HyperspaceAnalogueToLanguageBeforeCorrection implements SemanticSpace {
    ...
    private static final Logger LOGGER =
        Logger.getLogger(HyperspaceAnalogueToLanguageBeforeCorrection.class.getName());
     ...
     */
    public HyperspaceAnalogueToLanguageBeforeCorrection() {
     ...
     * configuration.
     */
    public HyperspaceAnalogueToLanguageBeforeCorrection(Properties properties) {
