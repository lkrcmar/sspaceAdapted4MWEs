 ...
 *      </b></code> <br>
 *      <i>Default:</i> {@link edu.ucla.sspace.hal.LinearWeighting edu.ucla.sspace.hal.LinearWeighting}
 *
 * <dd style="padding-top: .5em">This property sets the fully-qualified class
 *      name of the {@link edu.ucla.sspace.hal.WeightingFunction} class that will be used to
 ...
 */
public class HyperspaceAnalogueToLanguageLK implements SemanticSpace {
    ...
    /**
     * The property to set the {@link edu.ucla.sspace.hal.WeightingFunction} to be used with
    ...
    private static final Logger LOGGER =
            Logger.getLogger(HyperspaceAnalogueToLanguageLK.class.getName());
     ...
     */
    public HyperspaceAnalogueToLanguageLK() {
     ...
     * configuration.
     */
    public HyperspaceAnalogueToLanguageLK(Properties properties) {
    ...
    /**
     * Creates an instance of {@link edu.ucla.sspace.hal.WeightingFunction} based on the provide
     * class name.
     */
    ...
    public Set<String> getWords() {
        ...
        Map<String, Integer> sortedByIndices = MapUtil.sortByValue(termToIndex);
        System.out.print(sortedByIndices);
        System.out.println(sortedByIndices);
        return Collections.unmodifiableSet(sortedByIndices.keySet());
    }
