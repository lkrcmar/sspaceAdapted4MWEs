...
import cz.zcu.luk.sspace.common.GenericTermDocumentVectorSpaceSaveStats;
 ...
 */
public class LSASaveStats extends GenericTermDocumentVectorSpaceSaveStats
    ...
    /**
     * Creates a new {@link cz.zcu.luk.sspace.lsa.LSASaveStats} instance.  This intializes
     ...
     */
    public LSASaveStats() throws IOException {
    ...
    /**
     * Creates a new {@link cz.zcu.luk.sspace.lsa.LSASaveStats} instance with the specified
     ...
     */
    public LSASaveStats(int numDimensions) throws IOException {
     ...
     *        accessible
     */
    public LSASaveStats(int numDimensions,
     ...
     */
    public LSASaveStats(boolean retainDocumentSpace,
                        int dimensions,
     ...
     * cz.zcu.luk.sspace.lsa.LSASaveStats} if the document space has been retained.
     *
     ...
     *        cz.zcu.luk.sspace.lsa.LSASaveStats javadoc} for the full list of supported
     *        properties.
     */
     ...
     *        cz.zcu.luk.sspace.lsa.LSASaveStats} instance will be ignored, so documents
    ...
    public void saveStatistics(String dirPlusSpaceNameNoExtension) {
        Serializer.serializeData(transform, dirPlusSpaceNameNoExtension + ".trans");
        //Serializer.serializeData(termToIndex, dirPlusSpaceNameNoExtension + ".indmap"); // key words storing not needed..
        Serializer.serializeData(Vt, dirPlusSpaceNameNoExtension + ".vtmatrix");
        Serializer.serializeData(sigma, dirPlusSpaceNameNoExtension + ".smatrix");
        Serializer.serializeData(processedDocNumbers, dirPlusSpaceNameNoExtension + ".pdnums");
    }
}
