 ...
 */
public class LatentSemanticAnalysisModified extends GenericTermDocumentVectorSpace
...
//    }
    ...
    /**
     * Creates a new {@link cz.zcu.luk.sspace.lsa.LatentSemanticAnalysisModified} instance.  This intializes
     ...
     */
    public LatentSemanticAnalysisModified() throws IOException {
    ...
    /**
     * Creates a new {@link cz.zcu.luk.sspace.lsa.LatentSemanticAnalysisModified} instance with the specified
     ...
     */
    public LatentSemanticAnalysisModified(int numDimensions) throws IOException {
     ...
     *        accessible
     */
    public LatentSemanticAnalysisModified(int numDimensions,
     ...
     */
    public LatentSemanticAnalysisModified(boolean retainDocumentSpace,
                                          int dimensions,
                                          Transform transform,
    ...
    public String getSpaceName() {
        ...
        return "LSA-WordsSpace-D"+getDimensions()+"-"+getTransform().toString();
    }
