...
import cz.zcu.luk.sspace.coals.CoalsCompoundsStopwords;
import cz.zcu.luk.sspace.matrix.CorrelationTransformExtended;
 ...
 */
public class CoalsMainCompoundsStopwords extends GenericMainModifiedStopwords {

    /**
     * Uninstantiable.
     */
    private CoalsMainCompoundsStopwords() {
    }
    ...
    public static void main(String[] args) throws Exception {
        CoalsMainCompoundsStopwords coals = new CoalsMainCompoundsStopwords();
        coals.run(args);
    }
    ...
    public SemanticSpace getSpace() {
        ...
        if (reducer != null)
        System.out.println(reducer.toString());
        ...
        return new CoalsCompoundsStopwords(transform, reducer,
