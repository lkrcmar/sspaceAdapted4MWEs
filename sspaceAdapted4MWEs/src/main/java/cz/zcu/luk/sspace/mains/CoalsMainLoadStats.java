...
import cz.zcu.luk.sspace.coals.CoalsLoadStats;
 ...
 */
public class CoalsMainLoadStats extends GenericMainLoadStats {

    /**
     * Uninstantiable.
     */
    private CoalsMainLoadStats() {
    }
    ...
    public static void main(String[] args) throws Exception {
        CoalsMainLoadStats coals = new CoalsMainLoadStats();
        coals.run(args);
    }
    ...
    public SemanticSpaceLoadStats getSpace() {
        ...
        return new CoalsLoadStats(transform, reducer,
