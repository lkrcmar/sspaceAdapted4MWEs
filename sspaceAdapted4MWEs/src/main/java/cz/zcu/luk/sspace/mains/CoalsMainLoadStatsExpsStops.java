...
import cz.zcu.luk.sspace.coals.CoalsLoadStatsExpsStops;
 ...
 */
public class CoalsMainLoadStatsExpsStops extends GenericMainLoadStatsStopwords {

    /**
     * Uninstantiable.
     */
    private CoalsMainLoadStatsExpsStops() {
    }
    ...
    public static void main(String[] args) throws Exception {
        CoalsMainLoadStatsExpsStops coals = new CoalsMainLoadStatsExpsStops();
        coals.run(args);
    }
     ...
     * {@inheritDoc}
     */
    public SemanticSpaceLoadStats getSpace() {
        TransformExtended transform = null;
        SingularValueDecomposition reducer = (argOptions.hasOption("reduce"))
        ...
        return new CoalsLoadStatsExpsStops(transform, reducer,
