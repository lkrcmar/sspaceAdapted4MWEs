...
public abstract class GenericMainSaveStats extends GenericMain {

    private static final Logger LOGGER =
        Logger.getLogger(GenericMainSaveStats.class.getName());
    ...
    public void run(String[] args) throws Exception {
        ...
        SemanticSpaceSaveStats space = getSpace();
        ...
        String dirPlusSpaceNameNoExtension = configuration.get("dataDir") + File.separator +
                configuration.get("wordSpaceDir") + File.separator + space.getSpaceName() + "_" + argOptions.getPositionalArg(0);
        ...
        saveSStats(space, dirPlusSpaceNameNoExtension);
    ...
    private void saveSStats(SemanticSpaceSaveStats space, String dirPlusSpaceNameNoExtension) {
        space.saveStatistics(dirPlusSpaceNameNoExtension);
    }

    protected abstract SemanticSpaceSaveStats getSpace();
}
