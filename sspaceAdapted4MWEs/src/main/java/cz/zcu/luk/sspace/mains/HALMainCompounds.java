...
import cz.zcu.luk.sspace.hal.HyperspaceAnalogueToLanguageCompounds;
 ...
 */
public class HALMainCompounds extends GenericMainModified {

    private HALMainCompounds() { }
    ...
    public static void main(String[] args) throws Exception {
        HALMainCompounds hal = new HALMainCompounds();
        hal.run(args);
    }
    ...
    protected SemanticSpace getSpace() {
        ...
        return new HyperspaceAnalogueToLanguageCompounds(
