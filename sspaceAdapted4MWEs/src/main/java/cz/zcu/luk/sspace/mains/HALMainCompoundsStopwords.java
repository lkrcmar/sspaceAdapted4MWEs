...
import cz.zcu.luk.sspace.hal.HyperspaceAnalogueToLanguageCompoundsStopwords;


/**
 * An executable class for running {@link edu.ucla.sspace.hal.HyperspaceAnalogueToLanguage} (HAL)
 ...
 *
 * @see edu.ucla.sspace.hal.HyperspaceAnalogueToLanguage
 *
 * @author David Jurgens
 */
public class HALMainCompoundsStopwords extends GenericMainModifiedStopwords {

    private HALMainCompoundsStopwords() { }
    ...
    public static void main(String[] args) throws Exception {
        HALMainCompoundsStopwords hal = new HALMainCompoundsStopwords();
        hal.run(args);
    }
    ...
    protected SemanticSpace getSpace() {
        ...
        return new HyperspaceAnalogueToLanguageCompoundsStopwords(
                new StringBasisMapping(), windowSize, weighting,
                threshold, retain, compounds);
    }
