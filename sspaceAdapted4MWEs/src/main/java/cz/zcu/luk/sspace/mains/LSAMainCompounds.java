...
import cz.zcu.luk.sspace.lsa.LatentSemanticAnalysisModifiedCompounds;
 ...
 */
public class LSAMainCompounds extends GenericMainModified {

    private BasisMapping<String, String> basis;

    private LSAMainCompounds() {
    }
    ...
    public static void main(String[] args) throws Exception {
        LSAMainCompounds lsa = new LSAMainCompounds();
        lsa.run(args);
    }
    ...
    protected SemanticSpace getSpace() {
        try {
            ...
            return new LatentSemanticAnalysisModifiedCompounds(
