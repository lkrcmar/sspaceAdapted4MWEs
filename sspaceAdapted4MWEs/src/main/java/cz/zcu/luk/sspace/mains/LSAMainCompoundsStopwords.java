 ...
 * LK
 * copy of LSAMain
 * But only running in running LatentSemanticAnalysisModifiedCompounds changed!
 * and parent changed..
 *
...
import cz.zcu.luk.sspace.lsa.LatentSemanticAnalysisModifiedCompoundsStopwords;
 ...
 */
public class LSAMainCompoundsStopwords extends GenericMainModifiedStopwords {

    private BasisMapping<String, String> basis;

    private LSAMainCompoundsStopwords() {
    }
    ...
    public static void main(String[] args) throws Exception {
        LSAMainCompoundsStopwords lsa = new LSAMainCompoundsStopwords();
        lsa.run(args);
    }
    ...
    protected SemanticSpace getSpace() {
        try {
            ...
            // LK changed.. "ModifiedCompounds" added..
            return new LatentSemanticAnalysisModifiedCompoundsStopwords(
                    false, dimensions, transform, factorization, false, basis, compounds);
        } catch (IOException ioe) {
            throw new IOError(ioe);
        }
    }
