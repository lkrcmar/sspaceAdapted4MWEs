...
import cz.zcu.luk.sspace.lsa.LSALoadStats;
 ...
 */
public class LSAMainLoadStats extends GenericMainLoadStats {

    private BasisMapping<String, String> basis;

    private LSAMainLoadStats() {
    }
    ...
    public static void main(String[] args) throws Exception {
        LSAMainLoadStats lsa = new LSAMainLoadStats();
        lsa.run(args);
    }
