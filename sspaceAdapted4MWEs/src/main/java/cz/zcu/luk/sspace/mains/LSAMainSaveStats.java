...
import cz.zcu.luk.sspace.lsa.LSASaveStats;
 ...
 */
public class LSAMainSaveStats extends GenericMainSaveStats {

    private BasisMapping<String, String> basis;

    private LSAMainSaveStats() {
    }
    ...
    public static void main(String[] args) throws Exception {
        LSAMainSaveStats lsa = new LSAMainSaveStats();
        lsa.run(args);
    }
    
    protected SemanticSpaceSaveStats getSpace() {
        try {
