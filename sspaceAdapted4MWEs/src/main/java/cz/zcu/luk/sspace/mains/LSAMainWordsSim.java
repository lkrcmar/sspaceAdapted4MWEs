/*
 * LK
 * copy of LSAMainDocumentsSim
 * But only running in running LatentSemanticAnalysisModified changed! - false set
 * and parent changed..
 * to not handle header...
 *
...
public class LSAMainWordsSim extends GenericMainModified {
    ...
    public static void main(String[] args) throws Exception {
        LSAMainWordsSim lsa = new LSAMainWordsSim();
        lsa.run(args);
    }
    ...
    protected SemanticSpace getSpace() {
        try {
            ...
            // LK change ? - only preserves lsa instance..
...
//                lsaInst.getDocumentVector((299440))));
       ...
       /* DocumentSemanticSpace docSemSpace = new DocumentSemanticSpace(lsaInst);
        ...
        try {
            ...
            Map<String, String> configuration = ConfigReader.getInstance().getConfiguration();
            String lsaDocSpaces = configuration.get("baseDir") + "/" + FNandDNConsts.LSA_DOC_SPACES_DN;
