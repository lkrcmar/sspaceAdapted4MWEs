/*
 * LK.. using RandomIndexingModified where meaning for EMPTY_WORD IS NOT COUNTED..
 *
...
import cz.zcu.luk.sspace.ri.RandomIndexingModified;
 ...
 */
public class RIMain extends GenericMain {

    private static final Logger LOGGER
       = Logger.getLogger(RIMain.class.getName());
     ...
     */
    private RandomIndexingModified ri;
    ...
    protected SemanticSpace getSpace() {
        ...
        ri = new RandomIndexingModified(props);
