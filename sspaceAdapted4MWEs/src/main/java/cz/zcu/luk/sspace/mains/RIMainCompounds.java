...
import cz.zcu.luk.sspace.ri.RandomIndexingCompounds;
 ...
 */
public class RIMainCompounds extends GenericMainModified {

    private static final Logger LOGGER
       = Logger.getLogger(RIMainCompounds.class.getName());
     ...
     */
    private RandomIndexingCompounds ri;

    private RIMainCompounds() {
        ri = null;
    }
    ...
    public static void main(String[] args) {
        try {
            RIMainCompounds main = new RIMainCompounds();
            main.run(args);
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    protected SemanticSpace getSpace() {
        ...
        ri = new RandomIndexingCompounds(props, compounds);
