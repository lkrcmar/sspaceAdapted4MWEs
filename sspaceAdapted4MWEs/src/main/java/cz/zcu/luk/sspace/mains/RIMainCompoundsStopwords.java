...
import cz.zcu.luk.sspace.ri.RandomIndexingCompoundsStopwords;

/**
 * An executable class for running {@link edu.ucla.sspace.ri.RandomIndexing} from the command line.
 ...
 *
 * @see edu.ucla.sspace.ri.RandomIndexing
 *
 * @author David Jurgens
 */
public class RIMainCompoundsStopwords extends GenericMainModifiedStopwords {

    private static final Logger LOGGER
       = Logger.getLogger(RIMainCompoundsStopwords.class.getName());

    private Properties props;

    /**
     * The {@link edu.ucla.sspace.ri.RandomIndexing} instance used by this runnable.  This variable
     * is assigned after {@link #getSpace()} is called.
     */
    private RandomIndexingCompoundsStopwords ri;

    private RIMainCompoundsStopwords() {
        ri = null;
    }
    ...
    public static void main(String[] args) {
        try {
            RIMainCompoundsStopwords main = new RIMainCompoundsStopwords();
            main.run(args);
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Returns an instance of {@link edu.ucla.sspace.ri.RandomIndexing}.  If {@code loadVectors} is
     * specified in the command line options, this method will also initialize
     * the word-to-{@link edu.ucla.sspace.vector.TernaryVector} mapping.
     */
    protected SemanticSpace getSpace() {
        ...
        // LK changed.. added compounds
        ri = new RandomIndexingCompoundsStopwords(props, compounds);
