 ...
 */
public class CorrelationTransformExtendedSerialiazable extends BaseTransformExtended {
    ...
    public class CorrelationGlobalTransformExtended implements GlobalTransformExtended, Serializable {
...
//                                    colSums[column] * (totalSum - colSums[column]));
//            double tmp1 = (totalSum * value - rowSum * colSums[column]);
//            double tmp2 = Math.sqrt(rowSum * (totalSum - rowSum) * colSums[column] * (totalSum - colSums[column]));
//            System.out.println(tmp1);
//            System.out.println(tmp2);
//            System.out.println(newValue);
            double newValue;
            if (totalSum - rowSum > 0.0) {
                newValue =
                        (totalSum * value - rowSum * colSums[column]) /
                                Math.sqrt(rowSum * (totalSum - rowSum) *
                                        colSums[column] * (totalSum - colSums[column]));
                ...
                newValue =
                        (totalSum * value - rowSum * colSums[column]) /
                                Math.sqrt(rowSum * (1.0) *
                                        colSums[column] * (totalSum - colSums[column]));
            }
            if (newValue > 1.0) newValue = 1.0;
            double tmp1 = (totalSum * value - rowSum * colSums[column]);
            double tmp2 = Math.sqrt(rowSum * (totalSum - rowSum) * colSums[column] * (totalSum - colSums[column]));
            double tmp3 = Math.sqrt(rowSum * (1.0) * colSums[column] * (totalSum - colSums[column]));
//            System.out.println(tmp1);
//            System.out.println(tmp2);
//            System.out.println(tmp3);
//            System.out.println(newValue);
//            if (totalSum - rowSum > 0.0) System.out.println(true);
//            System.out.println();

// counting new occurrences           double newValue =
//                    ((totalSum + rowSum) * value - rowSum * (colSums[column]+value)) /
//                            Math.sqrt(rowSum * ((totalSum+rowSum) - rowSum) *
//                                    (colSums[column]+value) * ((totalSum+rowSum) - (colSums[column]+value)));

            // counnting new occurrences optimized
//            double newValue =
//                    (totalSum * value - rowSum * colSums[column]) /
//                            Math.sqrt(rowSum * totalSum *
//                                    (colSums[column]+value) * ((totalSum+rowSum) - (colSums[column]+value)));
//

          //  double tmp3 =  ((totalSum + rowSum) * value - rowSum * (colSums[column]+value));
          //  double tmp4 = Math.sqrt(rowSum * ((totalSum+rowSum) - rowSum) *(colSums[column]+value) * ((totalSum+rowSum) - (colSums[column]+value)));
