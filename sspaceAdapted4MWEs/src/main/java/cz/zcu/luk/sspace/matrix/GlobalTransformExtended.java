 ...
 * transformation.  This is a supplement to the more general {@link edu.ucla.sspace.matrix.Transform}
 ...
 * {@link edu.ucla.sspace.matrix.Transform} implementation.  A good example is the {@link
 * edu.ucla.sspace.matrix.TfIdfTransform}.
 *
 * </p> Note that most instances of a {@link cz.zcu.luk.sspace.matrix.GlobalTransformExtended} should be used
 ...
 */
public interface GlobalTransformExtended extends GlobalTransform {

    double transformColRow(int column, DoubleVector row);
}