 ...
 * row in a {@link edu.ucla.sspace.matrix.Matrix}.  The comparisons required for generating the list
...
public class RowComparator {
    ...
    public RowComparator() {
        this(System.getenv().get("PBS_NUM_PPN") == null ?
     ...
     *
     * @param m The {@link edu.ucla.sspace.matrix.Matrix} containing data points to be compared
     ...
     *        rows
     * @param kNearestRows The number of most similar rows to retain
     * @param simFunction The {@link edu.ucla.sspace.similarity.SimilarityFunction} to use when comparing
     *        rows
