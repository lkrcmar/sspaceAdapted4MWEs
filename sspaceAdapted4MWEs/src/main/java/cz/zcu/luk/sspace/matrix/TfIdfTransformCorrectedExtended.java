 ...
 */
public class TfIdfTransformCorrectedExtended extends BaseTransformExtended
    ...
    protected GlobalTransformExtended getTransform(Matrix matrix) {
        return new TfIdfGlobalTransformExtended(matrix);
    }
    ...
    protected GlobalTransformExtended getTransform(File inputMatrixFile,
                                           Format format) {
        return new TfIdfGlobalTransformExtended(inputMatrixFile, format);
    }
    ...
    public class TfIdfGlobalTransformExtended
         ...
         * Matrix}.
         */
        public TfIdfGlobalTransformExtended(Matrix matrix) {
         ...
         */
        public TfIdfGlobalTransformExtended(File inputMatrixFile, Format format) {
