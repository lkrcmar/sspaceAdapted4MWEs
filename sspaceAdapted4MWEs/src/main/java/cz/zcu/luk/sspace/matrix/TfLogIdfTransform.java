 ...
 */
public class TfLogIdfTransform extends BaseTransform
    ...
    protected GlobalTransform getTransform(Matrix matrix) {
        return new TfIdfLogGlobalTransform(matrix);
    }
    ...
    protected GlobalTransform getTransform(File inputMatrixFile,
                                           Format format) {
        return new TfIdfLogGlobalTransform(inputMatrixFile, format);
    }
    ...
    public class TfIdfLogGlobalTransform
         ...
         * Matrix}.
         */
        public TfIdfLogGlobalTransform(Matrix matrix) {
         ...
         */
        public TfIdfLogGlobalTransform(File inputMatrixFile, Format format) {
