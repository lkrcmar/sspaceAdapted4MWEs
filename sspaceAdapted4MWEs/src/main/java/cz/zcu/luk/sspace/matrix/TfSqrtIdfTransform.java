 ...
 */
public class TfSqrtIdfTransform extends BaseTransform
    ...
    protected GlobalTransform getTransform(Matrix matrix) {
        return new TfIdfSqrtGlobalTransform(matrix);
    }
    ...
    protected GlobalTransform getTransform(File inputMatrixFile,
                                           Format format) {
        return new TfIdfSqrtGlobalTransform(inputMatrixFile, format);
    }
    ...
    public class TfIdfSqrtGlobalTransform
         ...
         */
        public TfIdfSqrtGlobalTransform(Matrix matrix) {
         ...
         */
        public TfIdfSqrtGlobalTransform(File inputMatrixFile, Format format) {
