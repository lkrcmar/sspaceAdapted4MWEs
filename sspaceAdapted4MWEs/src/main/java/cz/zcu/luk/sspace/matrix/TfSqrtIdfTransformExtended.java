 ...
 */
public class TfSqrtIdfTransformExtended extends BaseTransformExtended
    ...
    protected GlobalTransformExtended getTransform(Matrix matrix) {
        return new TfIdfSqrtGlobalTransformExtended(matrix);
    }
    ...
    protected GlobalTransformExtended getTransform(File inputMatrixFile,
                                           Format format) {
        return new TfIdfSqrtGlobalTransformExtended(inputMatrixFile, format);
    }
    ...
    public class TfIdfSqrtGlobalTransformExtended
         ...
         * Matrix}.
         */
        public TfIdfSqrtGlobalTransformExtended(Matrix matrix) {
         ...
         */
        public TfIdfSqrtGlobalTransformExtended(File inputMatrixFile, Format format) {
        ...
        public double transform(int row, DoubleVector column) {
            ...
            double tf = Math.sqrt(column.get(row));
        ...
        public double transformColRow(int column, DoubleVector row) {
            double tf = Math.sqrt(row.get(column));
