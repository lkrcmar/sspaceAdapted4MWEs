 ...
 */
public class TokenCounterModified {
    ...
    private static final Logger LOGGER = 
        Logger.getLogger(TokenCounterModified.class.getName());
     ...
     */
    public TokenCounterModified(boolean doLowerCasing) {
    ...
    private void process(Iterator<String> tokens) {
        ...
        while (tokens.hasNext()) {
            ...
            // LK change.. not count numbers into one bucket, do not ignore special chars..
    ...
    public static void main(String[] args) {
        ...
        if (options.numPositionalArgs() < 2) {
            System.out.println(
                "usage: java TokenCounterModified"
        ...
        try {
            TokenCounterModified counter = new TokenCounterModified(doLowerCasing);
