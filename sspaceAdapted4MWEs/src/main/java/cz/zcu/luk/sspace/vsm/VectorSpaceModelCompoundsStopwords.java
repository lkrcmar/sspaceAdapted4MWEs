 ...
 *      fully qualified named of a class that implements {@link edu.ucla.sspace.matrix.Transform}.  The
 ...
 */
public class VectorSpaceModelCompoundsStopwords extends GenericTermDocumentVectorSpaceCompoundsStopwords {
     ...
     * @param transform
     */
    private VectorSpaceModelCompoundsStopwords(TransformExtended transform) throws IOException {
        super();
     ...
     *         the backing array files required for processing
     */
    public VectorSpaceModelCompoundsStopwords(
            boolean readHeaderToken,
            BasisMapping<String, String> termToIndex, TransformExtended transform,
            MatrixBuilder termDocumentMatrixBuilder, MatrixBuilder compoundsDocumentMatrixBuilder, Set<String> compounds) throws IOException {
        super(readHeaderToken, termToIndex, termDocumentMatrixBuilder, compoundsDocumentMatrixBuilder, compounds);
    ...
    public String getSpaceName() {
        return VSM_SSPACE_NAME + "_" + transform.toString();
    }

    /**
     * {@inheritDoc}
     *
     * @param properties {@inheritDoc} See this class's {@link cz.zcu.luk.sspace.vsm.VectorSpaceModelCompoundsStopwords
    ...
    public void processSpace(Properties properties) {
        try {
            ...
            if (compoundsInvolved) {
                compoundSpace = processCompoundSpace(transform);
            }
