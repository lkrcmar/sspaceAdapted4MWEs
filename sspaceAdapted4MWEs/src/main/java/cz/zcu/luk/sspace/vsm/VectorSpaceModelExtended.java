 ...
 */
// TODO: bad extend GTDVS Extended.. !!!!!!!!!!!
public class VectorSpaceModelExtended extends GenericTermDocumentVectorSpace {
     ...
     */
    public VectorSpaceModelExtended() throws IOException {
        super();
    }
     ...
     *         the backing array files required for processing
     */
    public VectorSpaceModelExtended(
    ...
    public String getSpaceName() {
        return VSM_SSPACE_NAME + getTransform().toString();
    }

    /**
     * {@inheritDoc}
     *
     * @param properties {@inheritDoc} See this class's {@link cz.zcu.luk.sspace.vsm.VectorSpaceModelExtended
