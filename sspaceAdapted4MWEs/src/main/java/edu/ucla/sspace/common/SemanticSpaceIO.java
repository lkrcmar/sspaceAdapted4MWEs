...
/**
 * A collection of utility methods for reading and writing {@link edu.ucla.sspace.common.SemanticSpace}
 ...
 * @see edu.ucla.sspace.common.StaticSemanticSpace
 * @see edu.ucla.sspace.common.OnDiskSemanticSpace
 */
public class SemanticSpaceIO {
     ...
     *         format.
     *
     * @throws java.io.IOException if any I/O exception occurs when reading the semantic
    ...
    /**
     * Loads and returns the {@link edu.ucla.sspace.common.SemanticSpace} from the file with the
     * specified name.
     *
     * @param sspaceFileName the name of a file containing a {@link
     *        edu.ucla.sspace.common.SemanticSpace} that has been written to disk
     *
    ...
    /**
     * Loads and returns the {@link edu.ucla.sspace.common.SemanticSpace} stored at the file in the
     * specified format.
     *
     * @param sspaceFileName the name of a file containing a {@link
     *        edu.ucla.sspace.common.SemanticSpace} that has been written to disk
     * @param format the format of the {@link edu.ucla.sspace.common.SemanticSpace} in the file
     *
     * @throws java.io.IOException if any I/O exception occurs when reading the semantic
     *         space data from the file
     */
    ...
    /**
     * Loads and returns the {@link edu.ucla.sspace.common.SemanticSpace} stored in the specified
     * file.
     *
     * @param sspaceFile a file containing a {@link edu.ucla.sspace.common.SemanticSpace} that has
    ...
    /**
     * Writes the data contained in the {@link edu.ucla.sspace.common.SemanticSpace} to the file with
    ...
    /**
     * Writes the data contained in the {@link edu.ucla.sspace.common.SemanticSpace} to the provided
        ...
        for (String word : words) {
            ...
            if (vector instanceof SparseVector) {
                if (vector instanceof DoubleVector) {
                    SparseDoubleVector sdv = (SparseDoubleVector)vector;
                    int[] nz = sdv.getNonZeroIndices();
                    // LK change - sorting added.. since load semantic space expect indices sorted..
                    // and this does not have to be the case - e.g. using Trove implementation..
                    Arrays.sort(nz);
