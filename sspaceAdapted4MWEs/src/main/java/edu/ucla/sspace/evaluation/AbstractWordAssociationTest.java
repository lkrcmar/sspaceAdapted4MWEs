...
/**
 * A test-runner for evaluating the performance of a {@link edu.ucla.sspace.common.SemanticSpace} on a
 * {@link edu.ucla.sspace.evaluation.WordSimilarityEvaluation} test.
 *
...
public abstract class AbstractWordAssociationTest
     ...
     * Returns a {@link edu.ucla.sspace.evaluation.WordSimilarityReport} detailing the performance, with
     * similarity scores scaled by the lowest and highest human based similarity
     * ratings.
     *
     * @param sspace The {@link edu.ucla.sspace.common.SemanticSpace} to test against
     *
     * @return A {@link edu.ucla.sspace.evaluation.WordSimilarityReport} detailing the performance
     */
