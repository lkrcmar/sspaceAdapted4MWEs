 ...
 * ReflectiveRandomIndexing#ReflectiveRandomIndexing(java.util.Properties)} constructor.
 *
 ...
 * #processDocument(java.io.BufferedReader) processDocument}.  The {@link
 * #getVector(String) getVector} method will only return valid reflective
 * vectors after the call to {@link #processSpace(java.util.Properties) processSpace}. <p>
 *
...
public class ReflectiveRandomIndexing implements SemanticSpace, Filterable {
     ...
     *
     * @see #processSpace(java.util.Properties)
     */
     ...
     * until {@link #processSpace(java.util.Properties)} is called, at which point the
   ...
   /**
    ...
    private void processSpace() throws IOException {
        ...
        for (int i = 0; i < (System.getenv().get("PBS_NUM_PPN") == null ? Runtime.getRuntime().availableProcessors() : (Integer.parseInt(System.getenv().get("PBS_NUM_PPN")) - 1)); ++i) {
