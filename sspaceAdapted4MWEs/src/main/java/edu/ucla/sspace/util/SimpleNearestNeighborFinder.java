...
/**
 * A native {@link edu.ucla.sspace.util.NearestNeighborFinder} implemetnation for finding the {@code
 * k} most-similar words to a provided word in a {@link edu.ucla.sspace.common.SemanticSpace} using a
...
public class SimpleNearestNeighborFinder implements NearestNeighborFinder {
    ...
    public SimpleNearestNeighborFinder(SemanticSpace sspace) {
        this(sspace, new CosineSimilarity(),
                (System.getenv().get("PBS_NUM_PPN") == null ?
    ...
    public SimpleNearestNeighborFinder(SemanticSpace sspace, SimilarityFunction similarity) {
        this(sspace, similarity, (System.getenv().get("PBS_NUM_PPN") == null ?
                Runtime.getRuntime().availableProcessors() :
                (Integer.parseInt(System.getenv().get("PBS_NUM_PPN")) - 1)));
    }
